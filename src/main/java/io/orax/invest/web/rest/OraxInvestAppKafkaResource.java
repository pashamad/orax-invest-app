...
@RestController
@RequestMapping("/api/orax-invest-app-kafka")
public class OraxInvestAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(OraxInvestAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public OraxInvestAppKafkaResource(KafkaProperties kafkaProperties) {
